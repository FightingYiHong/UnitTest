 ...
 * <p>
 * where n is the number of values, mean is the {@link org.apache.commons.math3.stat.descriptive.moment.Mean} and std is the
    ...
    */
    ...
    public double evaluate(final double[] values,final int begin,
        ...
        if (test(values, begin, length) && length > 2 ){
            org.apache.commons.math3.stat.descriptive.moment.Mean mean = new Mean();
