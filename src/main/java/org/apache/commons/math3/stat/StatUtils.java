...
public final class StatUtils {
    ...
    public static double[] normalize(final double[] sample) {
        org.apache.commons.math3.stat.descriptive.DescriptiveStatistics stats = new DescriptiveStatistics();
    ...
    private static double[] getMode(double[] values, final int begin, final int length) {
        ...
        org.apache.commons.math3.stat.Frequency freq = new Frequency();
