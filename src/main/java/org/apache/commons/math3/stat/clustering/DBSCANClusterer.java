 ...
 * {@link org.apache.commons.math3.stat.clustering.Cluster} objects will have no defined center, i.e. {@link org.apache.commons.math3.stat.clustering.Cluster#getCenter()} will
 * return {@code null}.
 *
...
public class DBSCANClusterer<T extends org.apache.commons.math3.stat.clustering.Clusterable<T>> {
     ...
     */
    public List<org.apache.commons.math3.stat.clustering.Cluster<T>> cluster(final Collection<T> points) throws NullArgumentException {

        // sanity checks
        MathUtils.checkNotNull(points);

        final List<org.apache.commons.math3.stat.clustering.Cluster<T>> clusters = new ArrayList<org.apache.commons.math3.stat.clustering.Cluster<T>>();
        final Map<org.apache.commons.math3.stat.clustering.Clusterable<T>, PointStatus> visited = new HashMap<org.apache.commons.math3.stat.clustering.Clusterable<T>, PointStatus>();
     ...
     */
    private org.apache.commons.math3.stat.clustering.Cluster<T> expandCluster(final Cluster<T> cluster,
                                                                              final T point,
