...
public class Mean extends AbstractStorelessUnivariateStatistic
    ...
    /**
     * {@inheritDoc}
     * <p>Note that when {@link #Mean(org.apache.commons.math3.stat.descriptive.moment.FirstMoment)} is used to
    ...
    public double evaluate(final double[] values, final double[] weights,
        ...
        if (test(values, weights, begin, length)) {
            org.apache.commons.math3.stat.descriptive.summary.Sum sum = new Sum();
