...
public class SimpleRegression implements Serializable, UpdatingMultipleLinearRegression {
    ...
    */
     ...
     * @throws org.apache.commons.math3.stat.regression.ModelSpecificationException if the length of {@code data[i]} is not
    ...
    public void addData(final double[][] data) throws org.apache.commons.math3.stat.regression.ModelSpecificationException {
        for (int i = 0; i < data.length; i++) {
            if( data[i].length < 2 ){
               throw new org.apache.commons.math3.stat.regression.ModelSpecificationException(LocalizedFormats.INVALID_REGRESSION_OBSERVATION,
                    data[i].length, 2);
            }
     ...
     * @throws org.apache.commons.math3.stat.regression.ModelSpecificationException if the length of {@code x} does not equal
     * the number of independent variables in the model
     */
    public void addObservation(final double[] x,final double y)
    throws org.apache.commons.math3.stat.regression.ModelSpecificationException {
        if( x == null || x.length == 0 ){
            throw new org.apache.commons.math3.stat.regression.ModelSpecificationException(LocalizedFormats.INVALID_REGRESSION_OBSERVATION,x!=null?x.length:0, 1);
        }
        addData( x[0], y );
    }
     ...
     * @throws org.apache.commons.math3.stat.regression.ModelSpecificationException if {@code x} is not rectangular, does not match
    ...
    public void addObservations(final double[][] x,final double[] y) throws org.apache.commons.math3.stat.regression.ModelSpecificationException {
        if ((x == null) || (y == null) || (x.length != y.length)) {
            throw new org.apache.commons.math3.stat.regression.ModelSpecificationException(
    ...
    */
     ...
     * @throws org.apache.commons.math3.stat.regression.ModelSpecificationException if the model is not correctly specified
     * @throws NoDataException if there is not sufficient data in the model to
     * estimate the regression parameters
     */
    public RegressionResults regress() throws org.apache.commons.math3.stat.regression.ModelSpecificationException, NoDataException {
        if (hasIntercept) {
            if (n < 3) {
