...
public class BinomialTest {
     ...
     * @see org.apache.commons.math3.stat.inference.AlternativeHypothesis
     */
    public boolean binomialTest(int numberOfTrials, int numberOfSuccesses, double probability,
                                org.apache.commons.math3.stat.inference.AlternativeHypothesis alternativeHypothesis, double alpha) {
    ...
    public double binomialTest(int numberOfTrials, int numberOfSuccesses, double probability,
                               org.apache.commons.math3.stat.inference.AlternativeHypothesis alternativeHypothesis) {
        if (numberOfTrials < 0) {
        ...
        default:
            throw new MathInternalError(LocalizedFormats. OUT_OF_RANGE_SIMPLE, alternativeHypothesis,
                      org.apache.commons.math3.stat.inference.AlternativeHypothesis.TWO_SIDED, AlternativeHypothesis.LESS_THAN);
        }
    }
}
