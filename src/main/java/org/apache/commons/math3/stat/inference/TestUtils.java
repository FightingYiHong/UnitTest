...
public class TestUtils  {
    ...
    private static final org.apache.commons.math3.stat.inference.ChiSquareTest CHI_SQUARE_TEST = new ChiSquareTest();

    /** Singleton OneWayAnova instance. */
    private static final org.apache.commons.math3.stat.inference.OneWayAnova ONE_WAY_ANANOVA = new OneWayAnova();

    /** Singleton G-Test instance. */
    private static final org.apache.commons.math3.stat.inference.GTest G_TEST = new GTest();

    /** Singleton K-S test instance */
    private static final org.apache.commons.math3.stat.inference.KolmogorovSmirnovTest KS_TEST = new KolmogorovSmirnovTest();
